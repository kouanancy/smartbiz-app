...
export const ROADMAP_PHASES = [
    ...
    fonctionnalites: [
      {
        ...
        description: "Date du dernier achat et produit favori directement sur la fiche client",
        disponible: true,
      },
      {
        icone: TrendingUp,
      ...
      },
      {
        ...
        description: "Un résumé de toute l'activité (CA, marge, points clés) par notification, pas seulement le stock",
        disponible: true,
      },
      {
  ...
  },
  {
    ...
    fonctionnalites: [
      ...
      {
        icone: Wrench,
        nom: "Module prestation de services",
        description: "Gérer aussi la vente de services (installation, coiffure, retouches, etc.), pas seulement des produits physiques en stock",
        disponible: false,
      },
    ],
  },
